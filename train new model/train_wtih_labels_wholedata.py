...
# Usage  python train_with_labels_wholedata.py
...
(x_train, y_train,count_set_train) = load_data_TF2(whole_data_TF)
print(x_train.shape, 'x_train samples')
save_dir = os.path.join(os.getcwd(),'whole_saved_models_T_32-32-64-64-128-128-512_e'+str(epochs))
